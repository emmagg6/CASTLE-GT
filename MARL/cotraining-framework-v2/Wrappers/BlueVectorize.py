...
class BlueVectorize():
    ...
    def reset(self, obs, action):
        ...
        obs = self.observation_change(obs, action, baseline=True)
        return obs


    def observation_change(self, observation, action, baseline=False):
    ...
    def _process_last_action(self, action=None):
