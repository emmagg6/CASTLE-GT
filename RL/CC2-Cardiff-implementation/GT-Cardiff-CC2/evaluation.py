...
if __name__ == "__main__":
    ...
    for trn_amnt in trn_amnts:
        ...
        for zeta in zetas : 
            ...
            file_name = '/scratch/egraham/CASTLE-GT/RL/CC2-Cardiff-implementation/GT-Cardiff-CC2/Evaluation/' + trn_amnt + "/" + cost_fcn + f'/PPOxCCE_z{zeta}.txt'
