...
class EscalateAction(ConcreteAction):
    ...
    def sim_escalate(self, state: State, user: str) -> Observation:
        ...
        #print('\n======self.state={}, target_host={}, session={}, target_session={}', self.state, target_host, session, target_session)
...
class ExploreHost(ConcreteAction):
    ...
    def sim_execute(self, state: State) -> Observation:
        ...
        #print('\n====ExploreHost target_host={}, agent={}, obs={}'.format(target_host, self.agent, obs))
        obs.set_success(True)
        return obs
