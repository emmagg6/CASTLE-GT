...
from CybORG.Shared.BlueRewardCalculator import HybridAvailabilityConfidentialityRewardCalculator, \
        HybridAvailabilityConfidentialityOperationsRewardCalculator
...
class AgentInterface:
    ...
    def create_reward_calculator(self, reward_calculator: str, agent_name: str, scenario: Scenario) -> RewardCalculator:
        ...
        elif reward_calculator == 'HybridAvailabilityConfidentialityOperations':
            calc = HybridAvailabilityConfidentialityOperationsRewardCalculator(agent_name, scenario)
        else:
