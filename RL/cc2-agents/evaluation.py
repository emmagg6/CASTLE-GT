...
if __name__ == "__main__":
    ...
    red_agents = [(partial(GreedyAgent), 'GreedyAgent'),
                  (partial(SleepAgent), 'SleepAgent'),
                  (partial(B_lineAgent), 'B_lineAgent'), 
                  (partial(RedMeanderAgent), 'RedMeanderAgent'), 
                  (partial(EvadeByRandom, sub_agent=SleepAgent,percent_random=100), 'RandomAgent'),
                # Issues with partially random implementation -- TODO: fix this
                #   (partial(EvadeByRandom, sub_agent=B_lineAgent,percent_random=10), 'EvadeByRandom_Bline_10'),
                #   (partial(EvadeByRandom, sub_agent=RedMeanderAgent,percent_random=10), 'EvadeByRandom_RedMeander_10'),
                  (partial(EvadeBySleep, sub_agent=B_lineAgent), 'EvadeBySleep_Bline'),
                  (partial(EvadeBySleep, sub_agent=RedMeanderAgent), 'EvadeBySleep_RedMeander'),
                  ]
