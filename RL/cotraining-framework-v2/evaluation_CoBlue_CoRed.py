...
if __name__ == "__main__":
    ...
    #blue_load_ckpt = "/net/data/idsgnn/cotrain_timesteps1000/Blue_56.pth"
    ...
    #red_load_ckpt = "/net/data/idsgnn/cotrain_timesteps1000/Red_56.pth"
    red_load_ckpt = "/net/data/idsgnn/cotrain_both/Red_25000.pth"
    # red_agent = RedPPOAgent(40, red_action_space, lr, betas, gamma, K_epochs, eps_clip, start_actions=start_actions_red,
    #                            ckpt_dir=red_load_dir, ckpt_old_dir=red_load_dir)

    red_agents = [(ft.partial(
                    RedPPOAgent, 
                    40, 
                    red_action_space, 
                    lr, 
        ...
        for red_agent, name in red_agents:
            ...
            for i in range(MAX_EPS):
                ...
                for j in range(num_steps):
                    while True:
                        try:
                            agent.action_space_dict = wrapped_cyborg.get_action_space_dict(agent_name)
                            agent.observation_dict = wrapped_cyborg.get_observation_dict(agent_name)
