...
if not os.path.exists(directory):
    ...
    for filename in sorted(os.listdir(directory)):
        if filename.startswith("PPOxCCEs_balance") and filename.endswith(".txt"):
    ...
    plt.savefig('/scratch/egraham/CASTLE-GT/RL/implementation/Results/plot.png')
    print("Plot saved to CASTLE-GT/RL/implementation/Results/plot.png")