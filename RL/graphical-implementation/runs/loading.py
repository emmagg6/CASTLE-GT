...
class loading():
    ...
    def load_all(self, path):
        with open(os.path.join(path, 'full_TEST_dists.pkl'), 'rb') as f:
            self.distances = pickle.load(f)

        with open(os.path.join(path, 'full_TEST_paths.pkl'), 'rb') as f:
        ...
        with open(os.path.join(path, 'full_TEST_cce_percentages.pkl'), 'rb') as f:
            self.cce_precents = pickle.load(f)

        with open(os.path.join(path, 'full_TEST_zetavalues.pkl'), 'rb') as f:
            self.zetas = pickle.load(f)

        with open(os.path.join(path, 'full_TEST_all_zetas.pkl'), 'rb') as f:
