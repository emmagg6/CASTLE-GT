...
# only changes involve keeping track of decoys, adding scanning states, reduction of action space, and returning the loss at each step for the CCE approximation
