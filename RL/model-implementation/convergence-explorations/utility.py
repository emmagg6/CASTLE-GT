...
def plot_regret(names_list,regretper_stateIterationEQObserver,regretper_stateEQObserver,regretEQAgent,regretper_stateEQAgent,regretper_stateIterationEQAgent):
    ...
    # plt.plot(time_steps, cumulative_losses, label="EXP3-IX", color="blue",linestyle="dashed")
    ...
    y = np.arange(1, 10000)
    x = y / 40
    plt.plot(y, x, label='Linear Regret Line', color='blue', linestyle='dashed')
