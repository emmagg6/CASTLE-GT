...
class Portscan(ConcreteAction):
    ...
    def sim_execute(self, state: State) -> Observation:
                    ...
                    for i in state.hosts[from_host].interfaces:
                        if i.ip_address != lo:
                            if i.subnet == from_subnet:
                                ...
                                #print("\n>>>originating_ip_address={}".format(originating_ip_address))
        ...
        #print('\n""""Portscan:')
        #for elem in target_host.events['NetworkConnections']:
        #    print(elem)
        #print('""""Portscan state.ip_addressesi={}, target_host={}'.format(self.state.ip_addresses, target_host.hostname))
        #print('""""Portscan obs: ', obs)
        return obs
